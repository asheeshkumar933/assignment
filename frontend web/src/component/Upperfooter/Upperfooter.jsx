          ...
          <div className=" grid grid-cols-2   gap-5 sm:gap-6 sm:grid-cols-3">
            ...
            <div className=' text-gray-700'>
              ...
              <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, delectus.</p>
               <input className="mt-10 p-1 text-gray-600"  type="email" name="email" id="email" placeholder="Enter your mail.." />
               <label className="p-4 ml-4 cursur-pointer  border-white" htmlFor="email">email</label>
               
            </div>
            <hr className=" my-6 border-gray-400 sm:mx-auto lg:my-8 md:hidden" />
            <div className="  p-4 ml-80 text-gray-700">
              <h2 className="mb-10  text-sm font-semibold text-gray-900 uppercase">
                Callus
              </h2>
              ...
              <p className="text-xl text-white mt-2  mb-2 font-bold">CURRENCY</p>
